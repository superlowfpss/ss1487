...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        public AudioTab()
        {
            ...
            TtsVolumeSlider.OnValueChanged += OnTtsVolumeSliderChanged; // SS220-TTS
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(CCCVars.TTSVolume, TtsVolumeSlider.Value / 100f); // SS220-TTS
            _cfg.SetCVar(CCCVars.TTSRadioVolume, TtsRadioVolumeSlider.Value / 100f); // SS220-TTS
            _cfg.SetCVar(CCCVars.TTSAnnounceVolume, TtsAnnounceVolumeSlider.Value / 100f); // SS220-TTS
        ...
        private void Reset()
        {
            ...
            TtsVolumeSlider.Value = _cfg.GetCVar(CCCVars.TTSVolume) * 100f; // SS220-TTS
            TtsRadioVolumeSlider.Value = _cfg.GetCVar(CCCVars.TTSRadioVolume) * 100f; // SS220-TTS
            TtsAnnounceVolumeSlider.Value = _cfg.GetCVar(CCCVars.TTSAnnounceVolume) * 100f; // SS220-TTS
        ...
        private void UpdateChanges()
        {
            ...
            var isTtsVolumeSame =
                Math.Abs(TtsVolumeSlider.Value - _cfg.GetCVar(CCCVars.TTSVolume) * 100f) < 0.01f; // SS220-TTS
            var isTtsRadioVolumeSame =
                Math.Abs(TtsRadioVolumeSlider.Value - _cfg.GetCVar(CCCVars.TTSRadioVolume) * 100f) < 0.01f; // SS220-TTS
            var isTtsAnnounceVolumeSame =
                Math.Abs(TtsAnnounceVolumeSlider.Value - _cfg.GetCVar(CCCVars.TTSAnnounceVolume) * 100f) < 0.01f; // SS220-TTS
            ...
            isEverythingSame = isEverythingSame && isTtsRadioVolumeSame && isTtsVolumeSame && isTtsAnnounceVolumeSame; // SS220-TTS
            isEverythingSame = isEverythingSame && isAHelpSoundsSame && isAHelpVolumeSame; // SS220-Ahelp Sounds Volume
            ...
            TtsVolumeLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", TtsVolumeSlider.Value / 100)); // SS220-TTS
            TtsRadioVolumeLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", TtsRadioVolumeSlider.Value / 100)); // SS220-TTS
            TtsAnnounceVolumeLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", TtsAnnounceVolumeSlider.Value / 100)); // SS220-TTS
