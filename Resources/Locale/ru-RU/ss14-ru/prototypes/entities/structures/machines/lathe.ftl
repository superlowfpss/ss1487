...
ent-CutterMachine = лазерный станок #SS220 Loc-Change
    .desc = Это лазерный станок. Он вырезает разнообразные плитки. Придайте разнообразия полу вашей станции с помощью интересных узоров! Не засовывайте внутрь пальцы. #SS220 Loc-Change
