...
public sealed partial class ChemistrySystem
{
    ...
    private bool UseInjector(Entity<InjectorComponent> injector, EntityUid target, EntityUid user) // SS220 Placeable-Items
    {
    ...
    private void OnInjectDoAfter(Entity<InjectorComponent> entity, ref InjectorDoAfterEvent args)
    {
        ...
        args.Handled = UseInjector(entity, args.Args.Target.Value, args.Args.User); // SS220 Placeable-Items
    }
    ...
    private void OnInjectorAfterInteract(Entity<InjectorComponent> entity, ref AfterInteractEvent args)
    {
        ...
        args.Handled = UseInjector(entity, target, args.User); // SS220 Placeable-Items
    }
