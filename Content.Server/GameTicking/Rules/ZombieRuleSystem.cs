...
public sealed class ZombieRuleSystem : GameRuleSystem<ZombieRuleComponent>
{
    ...
    private void InfectInitialPlayers(ZombieRuleComponent component)
    {
        ...
        var allPlayers = _antagSelection.GetEligiblePlayers(_playerManager.Sessions, component.PatientZeroPrototypeId, acceptableAntags: Shared.Antag.AntagAcceptability.All, includeAllJobs: true, ignorePreferences: true,
        customExcludeCondition: (entity) => { return HasComp<ZombieImmuneComponent>(entity) || !(entity.HasValue && _jobs.CanBeZombie(entity.Value)); }); // SS220 No-Zombie-Roles begin
