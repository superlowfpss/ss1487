...
namespace Content.Server.Atmos.EntitySystems
{
    ...
    public sealed class GasTankSystem : EntitySystem
    {
        ...
        public bool CanConnectToInternals(Entity<GasTankComponent> ent)
        {
            ...
            //return internalsComp != null && internalsComp.BreathTools.Count != 0 && !ent.Comp.IsValveOpen; // 220 internals mask toggle
            return internalsComp != null && !ent.Comp.IsValveOpen; // 220 internals mask toggle
        }
