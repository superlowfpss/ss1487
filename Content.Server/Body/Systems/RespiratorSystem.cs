...
public sealed class RespiratorSystem : EntitySystem
{
    ...
    [Dependency] private readonly ChatSystem _chat = default!; // SS220 Gasp-Emote
    ...
    private void StopSuffocation(EntityUid uid, RespiratorComponent respirator)
    {
        ...
        _damageableSys.TryChangeDamage(uid, respirator.DamageRecovery, damageable: damageable);
        //SS220 air_fix end
    }
